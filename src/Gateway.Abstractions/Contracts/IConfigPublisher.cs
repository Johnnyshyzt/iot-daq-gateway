...
/// in <c>docs/config/README.md</c>. Studio.Host.ConfigStore publishes files in M1
/// and does not implement this interface yet. Gateway.Host does not register one.
/// </summary>
