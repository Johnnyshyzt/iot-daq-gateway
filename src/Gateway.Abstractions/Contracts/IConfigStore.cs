...
/// Studio.Host.ConfigStore is the M1 file store and does not implement this interface yet.
/// Gateway.Host reads published YAML directly and does not register an implementation.
/// </summary>
