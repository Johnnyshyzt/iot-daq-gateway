...
DAQ pages in this folder talk to `Studio.Host` at `/api/v1`. The application shell (sidebar, header, sign-in card, theme drawer, Tailwind setup) is adapted from [shadcn-admin](https://github.com/satnaing/shadcn-admin) v2.2.1 by [Sat Naing](https://github.com/satnaing).
...
npm run build  # writes dist/ for Studio.Host
```

How this UI runs next to the gateway is in [../README.md](../README.md).
